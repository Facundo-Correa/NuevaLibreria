...
return [
    ...
    */
    ...
    'providers' => [
        ...
        TypiCMS\Modules\Booklists\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Mercadolibrepedidos\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Mercadolibrepreguntas\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Mercadolibrepublicaciones\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Preguntas\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Pedidos\Providers\ModuleServiceProvider::class,
        ...
        /*
            ...
            Módulo Libros:
                Utilizado para desplegar la informacion de un libro en particular.

            Módulo Listados:
                Utilizado para desplegar un listado de libros en una categoria.

            Módulo Books:
                Misma utilidad de antes. Se utiliza para guardar modelo de libro
                en base de datos, asi como para traerle a la vista.

            Módulo Categories:
                Sin utilidad actualmente.

            Faltantes:
                Módulo BookCategories: presente en base de datos pero sin modelo
                en codigo. Sin posibilidad de listar categorias hasta no tener
                presente el modelo.

         */
        TypiCMS\Modules\Categorias\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Books\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Promocions\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Carrusels\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Publicidades\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Configuraciones\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Features\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Exposiciones\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Clientesinternacionales\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Contadores\Providers\ModuleServiceProvider::class,
